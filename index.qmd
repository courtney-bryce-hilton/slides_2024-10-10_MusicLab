...
- can't combine (easily) with eye tracking
...
![](media/figures/deeplabcut_logo.png){width="90%"}
:::

::: {.column width="50%"}

![](media/figures/sam_logo.png){width="90%"}
:::
:::
...
<figure>
  <img src="./media/figures/validation.png" class="center" width="70%">
  <figcaption>Bainbridge, Bertolo, et al., 2021, *Nature Human Behaviour*</figcaption>
</figure>
